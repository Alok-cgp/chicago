  ...
  return _createClass(ObjectUtils2, null, [{
    ...
    value: function absoluteCompare(objA, objB) {
      ...
      for (var _i = 0, _aKeys = aKeys; _i < _aKeys.length; _i++) {
        ...
        if ((isObject || isFunction) && !this.absoluteCompare(aValue, bValue, maxDepth, currentDepth + 1))
          return false;
    ...
    value: function selectiveCompare(a, b, keysToCompare) {
      ...
      if (!a || !b || _typeof(a) !== "object" || _typeof(b) !== "object")
        return false;
      if (!keysToCompare)
        return this.absoluteCompare(a, b, 1);
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
          ...
          if (isObject && !this.absoluteCompare(aValue, bValue, maxDepth))
            return false;
          if (!isObject && aValue !== bValue)
            return false;
        }
...
//# sourceMappingURL=chunk-ZDHIT6MR.js.map
